        ...
        <PreparationContainer>
          ...
          <StepList>
            <StepListItem>
              ...
              justo pellentesque id. Aliquam ac nunc sed leo bibendum ultrices.
              Proin at lacus sed tellus commodo varius. Suspendisse magna augue,
              iaculis eget urna eu, blandit ullamcorper enim. In mollis et lacus
              condimentum laoreet. In et lobortis turpis, id gravida dolor.
              Fusce eu sollicitudin neque, sed cursus libero. Phasellus non
              malesuada ligula, aliquet fermentum dolor. Phasellus hendrerit
              imperdiet fringilla. Aliquam sed justo porta, pharetra lacus nec,
              viverra leo. Interdum et malesuada fames ac ante ipsum primis in
              faucibus. Vestibulum consectetur eros id ex faucibus dapibus.
              Morbi luctus scelerisque blandit.
            </StepListItem>
            <StepListItem>
              Vestibulum non sodales purus, a imperdiet nisi. Donec vulputate
              urna fermentum blandit rutrum. Aliquam sodales nibh a sem gravida,
              hendrerit sagittis magna elementum. Morbi lacinia at lectus id
              commodo. Vestibulum lobortis nunc vitae mauris pretium efficitur.
              Aenean a condimentum ex. Donec sit amet lorem ut purus egestas
              rutrum accumsan quis mauris. In id blandit lectus, a placerat
              libero. Integer sodales eros a elementum euismod. Etiam quis nibh
              nec risus varius tristique.{" "}
            </StepListItem>
            <StepListItem>
              Curabitur vehicula, sapien euismod hendrerit elementum, nunc arcu
              ullamcorper turpis, quis sollicitudin odio ante id est. Nulla
              facilisi. Proin eget egestas lacus. Nunc maximus venenatis lacus
              ut congue. Morbi imperdiet tellus id augue vehicula mollis id eu
              quam. Aenean lobortis magna luctus sapien dignissim pulvinar. Cras
              feugiat facilisis ex quis posuere. Donec turpis dolor, dictum et
              imperdiet id, malesuada faucibus metus. Pellentesque imperdiet dui
              tortor, sit amet varius libero elementum ut.
            </StepListItem>
          </StepList>
        </PreparationContainer>
      </Wrapper>
